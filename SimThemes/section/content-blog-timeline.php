...
$excerpt_full_content =  ot_get_option('blog_excerpt_full_content');
...
$title_size_ind =  ot_get_option('title_size_ind');
                        ...
                        <li <?php if($i%2==0) echo 'class="timeline-inverted scrollimation fade-right"'; else echo 'class="scrollimation fade-left"'; ?>>
							...
							echo '<img class="img-responsive" src="' . $url_thumb . '" alt="">';
                                ...
                                <div class="timeline-body text-justify">
                                    <h2 class="font-light" ><a href="<?php the_permalink(); ?>" style=" <?php if(!empty($title_size_ind)){echo 'font-size:'.$title_size_ind['0'].$title_size_ind['1'];} ?>; " title="<?php the_title_attribute(); ?>"><?php the_title() ?></a></h2>
