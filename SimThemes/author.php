			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="col-sm-9 clearfix" role="main">
					...
					<div class="page-header"><h1 class="archive_title h2">
						<span><?php _e("Posts By:", "SimThemes"); ?></span> 
						<?php 
					...
					<?php } else { // if it is disabled, display regular wp prev & next links ?>
						<nav class="wp-prev-next">
							<ul class="clearfix">
								<li class="prev-link"><?php next_posts_link(_e('&laquo; Older Entries', "SimThemes")) ?></li>
								<li class="next-link"><?php previous_posts_link(_e('Newer Entries &raquo;', "SimThemes")) ?></li>
							</ul>
						</nav>
					<?php } ?>
					...
					<article id="post-not-found">
					    <header>
					    	<h1><?php _e("No Posts Yet", "SimThemes"); ?></h1>
					    </header>
					    <section class="post_content">
					    	<p><?php _e("Sorry, What you were looking for is not here.", "SimThemes"); ?></p>
					    </section>
					    <footer>
					    </footer>
					</article>
