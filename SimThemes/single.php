...
if (class_exists('ST_core')) {$ST_core = new ST_core();}
 get_header(); 
 global $post;
$blog_ind_sidebar =  ot_get_option('blog_ind_sidebar');
...
if($blog_ind_sidebar=='no_sidebar'){
	$column = 'col-sm-12';
	}else{
	$column = 'col-sm-9';
		}		
    ...
    <section class="main-content-section">
        <div class="container">
			<div id="content" class="clearfix row">
				...
				<?php if($blog_ind_sidebar=="left_sidebar") {get_sidebar('single'); } // sidebar 1 ?>
            ...
            <div id="main" class="<?php echo $column; ?> clearfix" role="main">
				  ...
				  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                        ...
                        <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
								...
								<?php get_template_part( 'section/post/content', 'single-post' );  ?>                                            
                        		<?php 
				...
				<?php if($blog_ind_sidebar=="right_sidebar") {get_sidebar('single'); } // sidebar 1 ?>
