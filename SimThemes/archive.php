    ...
    <section class="main-content-section blog-multiple">
        <div class="container">
			<div id="content" class="clearfix <?php echo $row; ?>">
				<?php if($blog_sidebar=="left_sidebar") {get_sidebar('archive'); } // sidebar 1 ?>
				
                
                <?php 
				if($blog_layout=="time_line"){
				get_template_part( 'section/content', 'archive-timeline' );
				}else{
				get_template_part( 'section/content', 'archive-basic' );
				}
				 ?>
				...
				<?php if($blog_sidebar=="right_sidebar") {get_sidebar('archive'); } // sidebar 1 ?>
